...
<body>
  ...
  <img src="https://images.app.goo.gl/fP6SCeyZzmjXd7Q59" style="max-height:150px" class="img-responsive" alt="...">
  <div class="card-body">
    <h5 class="card-title">Product title</h5>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    <div class="pull-left">₹ 500</div>
    <a href="/cart" class="btn btn-primary pull-right">Add to cart</a>
  </div>
</div>
