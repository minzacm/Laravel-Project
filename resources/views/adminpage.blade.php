    ...
    <header>
       ...
       <div class="header-area">
            <div class="main-header ">
                ...
                <li class="d-none d-lg-block"> <a href="/login" class="btn header-btn">Logout</a></li>
                            ...
                            <div class="col-xl-6 col-lg-8 col-md-7 col-sm-5">
                                ...
                                <div class="main-menu f-right d-none d-lg-block">
                                    <nav>                                                
                                        <ul id="navigation">                                                                                                                                     
                                            <li><a href="/">Home</a></li>
                                            <li><a href="/category">Add Catagory</a></li>
                                            <li><a href="/item"> Add Product</a></li>
                                            <li><a href="/oview">VieW Orders</a></li>
                                            <li><a href="/oreport">VieW Orders Report</a></li>
                                                
                                            <li><a href="/cview">View Customer</a>
                                            <li><a href="#">Pages</a>
                                                <ul class="submenu">
                        ...
                        <div class="row d-flex align-items-center justify-content-between">
                            ...
                            <div class="col-xl-5 col-lg-5 col-md-5 col-sm-8">
                                <div class="hero__caption">
                                    <span data-animation="fadeInRight" data-delay=".4s"></span>
                                    <h1 data-animation="fadeInRight" data-delay=".6s">ADMIN<br> HOME</h1>
                                    <p data-animation="fadeInRight" data-delay=".8s"></p>
                                    <!-- Hero-btn -->
