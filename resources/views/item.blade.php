...
<h6 class="mb-0">
Product
<a href="/itemadd" class="badge bg-primary p-2 text-white float-right">Add item</a>
</h6>
</div>
</div>
</div>
...
<td>
<a class="btn btn-warning" href={{"/itemedit/".$item->id}}>EDIT</a>
<a class="btn btn-danger" href={{"/itemdelete/".$item->id}}>DELETE</a>
</td>
</tr>
@endforeach
